...
class OfferListAdapter : RecyclerView.Adapter<OfferListAdapter.ViewHolder>() {
    ...
    // Update offer list with DiffUtil
    fun updateList(newOfferList: List<Offer>) {
        val diffCallback = OfferDiffCallback(items, newOfferList)
    ...
    inner class ViewHolder(
        ...
        fun bind(offer: Offer) {
            ...
            with(binding) {
                ...
                Glide.with(context)
                    .load(flight.airline.imageUrl) // Assuming imageUrl is the URL of the airline image
    ...
    // OfferDiffCallback class for calculating differences between old and new lists
